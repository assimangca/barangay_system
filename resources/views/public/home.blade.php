...
<body class="min-h-screen overflow-x-hidden bg-[#071326] text-slate-900">
    ...
    <div class="fixed inset-0 z-0 overflow-hidden pointer-events-none">
        ...
        <div class="absolute inset-0 opacity-15"
            style="background-image:linear-gradient(to right, rgba(255,255,255,0.10) 1px, transparent 1px),linear-gradient(to bottom, rgba(255,255,255,0.10) 1px, transparent 1px);background-size: 90px 90px;"></div>
    ...
    <main class="relative z-10 mx-auto flex min-h-[calc(100vh-80px)] max-w-[1500px] items-center justify-center px-6 py-16 overflow-hidden">
                ...
                <div class="rounded-[2rem] bg-white/80 backdrop-blur-md p-8 shadow-2xl ring-1 ring-white/10">
                    <div class="relative mb-8 flex h-72 items-center justify-center overflow-hidden rounded-2xl bg-gradient-to-br from-blue-700 to-blue-950 text-white">
                        <svg class="absolute inset-0 h-full w-full opacity-30" viewBox="0 0 800 400" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <path d="M180 40 V360 M360 40 V360 M540 40 V360 M720 40 V360" stroke="white" stroke-width="1.5" />
                            <path d="M40 100 H760 M40 200 H760 M40 300 H760" stroke="white" stroke-width="1.5" />
                        </svg>
                        ...
                        <div class="relative z-10 animate-bounce">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="h-24 w-24 text-white drop-shadow-[0_10px_25px_rgba(0,0,0,0.45)]">
                    ...
                    <div class="pb-2 text-center">
                        <h3 class="text-3xl font-extrabold tracking-wide leading-tight text-blue-950">VISIT OUR PAGE</h3>
    ...
    <style>
        .magic-text {
            ...
            overflow: hidden;
            background: linear-gradient(90deg, #60a5fa 0%, #e0f2fe 18%, #ffffff 30%, #f9a8d4 45%, #ec4899 58%, #c084fc 75%, #93c5fd 100%);
            background-size: 220% 220%;
            -webkit-background-clip: text;
            background-clip: text;
            color: transparent;
            -webkit-text-fill-color: transparent;
            filter: drop-shadow(0 0 14px rgba(236, 72, 153, 0.20)) drop-shadow(0 0 22px rgba(96, 165, 250, 0.18));
        ...
        .shine-text::after {
            ...
            background: linear-gradient(to right, transparent 0%, rgba(255, 255, 255, 0.12) 35%, rgba(255, 255, 255, 0.85) 50%, rgba(255, 255, 255, 0.12) 65%, transparent 100%);
